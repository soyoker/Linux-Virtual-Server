...
<img src="images/ServerLoadBalance.jpg">

1.用户访问对外发布的服务器地址

2.虚拟服务器即负载均衡器接到用户请求后，根据算法将服务请求发送至后端某台服务器

3.后端服务器得到用户请求后向缓存服务器调取用户数据

4.缓存服务器得到后端服务器的用户数据调取请求后，返回用户数据

5.后端服务器根据缓存服务器返回的用户数据开始为用户提供服务

#### 客户端负载均衡

<img src="images/UserLoadBalance.jpg">
